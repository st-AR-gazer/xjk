...
const elements = {
  ...
  dodecahedron: {
    title: "Dodecahedron", img: "assets/solids/Dodecahedron.png",
    props: { w: 180, h: 180, x: null, y: null, rot: 0 }
  },
  tetrahedron: {
    title: "Tetrahedron", img: "assets/solids/Tetrahedron.png",
    props: { w: 180, h: 180, x: null, y: null, rot: 0 }
  },
  cube: {
    title: "Cube", img: "assets/solids/Cube.png",
    props: { w: 180, h: 180, x: null, y: null, rot: 0 }
  },
  octahedron: {
    title: "Octahedron", img: "assets/solids/Octahedron.png",
    props: { w: 180, h: 180, x: null, y: null, rot: 0 }
  },
  icosahedron: {
    title: "Icosahedron", img: "assets/solids/Icosahedron.png",
    props: { w: 180, h: 180, x: null, y: null, rot: 0 }
  }
};
...
function ctrl(prop, el) {
  ...
  r.oninput = () => { n.value = r.value; el.props[prop] = parseInt(r.value, 10); };
  n.oninput = () => { r.value = n.value; el.props[prop] = parseInt(n.value, 10); };
...
generateBtn.onclick = async () => {
  ...
  try {
    ...
    const { id, url, expires } = await res.json();
    ...
    window.__addBannerHistory(id, url, expires);
  } catch (e) {
