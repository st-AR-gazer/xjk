...
import {
  normalizeTrafficBytes as normalizeBytes,
  normalizeTrafficDirection as normalizeDirection,
  normalizeTrafficDurationMs as normalizeDuration,
  normalizeTrafficHost as normalizeHost,
  normalizeTrafficMethod as normalizeMethod,
  normalizeTrafficPath as normalizePath,
  normalizeTrafficStatusCode as normalizeStatusCode,
      ...
      checks: Array.isArray(checks)
        ? checks.map((item) => ({
            ...
            accountIds: Array.isArray(item.accountIds)
              ? item.accountIds.map((value) => String(value || "").trim()).filter(Boolean)
              : [],
